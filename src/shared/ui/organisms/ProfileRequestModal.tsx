...
const ProfileRequestModal: React.FC<ProfileRequestModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl w-[85.49vw] flex flex-col items-center px-[12vw] py-[4.6vh]">
        ...
        <textarea
          ...
          className="w-full h-20 bg-[#CACACA] p-[2vw] text-hakgyo-r-14 text-[#555555] resize-none mb-[2vh] outline-none focus:outline-none"
          maxLength={50}
